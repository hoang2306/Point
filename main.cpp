...
#include "header/Me.hpp"
#include "header/Rope.hpp"
#include "header/EventManager.hpp"
#include "header/ObjectManager.hpp"
#include "header/Lava.hpp"
...
int main(int argc, char* args[])
{
    ...
    music = Mix_LoadMUS("sound/happy_fun_bg.mp3");
    sound = Mix_LoadWAV("sound/eat_point.wav");
    blast = Mix_LoadWAV("sound/dead.wav");
...
//    class Lava* lava = new Lava(0, 625, 500, 1280);
    ...
    SDL_Texture* grassTexture = window.loadTexture("texture/BLACK.jpg");
